...
<div class="hero-wrap js-fullheight" style="background-image: url('front/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="img mr-4 rounded" style="background-image: url(front/images/image_1.jpg);"></a>
                        <div class="text">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="img mr-4 rounded" style="background-image: url(front/images/image_2.jpg);"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                            <div class="meta">
                                <div><a href="#"></span> Oct. 16, 2019</a></div>
...
<script src="j{{'/'}}front/s/jquery.easing.1.3.js"></script>
