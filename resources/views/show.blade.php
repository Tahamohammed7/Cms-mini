        ...
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                ...
                <div class="about-author d-flex p-4 bg-light">
                    <div class="bio mr-5">
                        <img src="{{$user->hasPicture() ? asset('storage/'.$user->getPicture()) : $user->getGravatar()}}" alt="Image placeholder" class="img-fluid mb-4">
                    </div>
                    <div class="desc">
                        <h3>{{$user->name}}</h3>
                        <p>{{$profile->about}}</p>
            ...
            <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="tagcloud">
                        @foreach($tags as $tag)
                        <a href="{{url('post/'.$tag->id)}}" class="tag-cloud-link">{{$tag->name}}</a>
                        @endforeach
                    </div>
