            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    ...
                    <div class="text p-4 float-right d-block">
                        ...
                        <h3 class="heading mb-3"><a href="{{url('post/'.$post->id)}}">{{$post->title}}</a></h3>
                        <p>{{$post->description}}</p>
                        <p><a href="{{url('post/'.$post->id)}}" class="btn-custom"><span class="ion-ios-arrow-round-forward mr-3"></span>Read more</a></p>
                    </div>
                </div>
            </div>
                @endforeach
